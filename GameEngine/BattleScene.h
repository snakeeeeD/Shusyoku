...
public:
    ...
    struct TrapQueue {
        ...
        bool   full = false;      // Detonate用
        Enemy* enemy = nullptr;   // Trigger用
...
private:
    ...
    void SummonNear(Enemy* src, const std::string& id, int count);
    ...
    struct Deco { float x, z, scale; int type; };   // type: 0=木 1=茂み 2=岩
